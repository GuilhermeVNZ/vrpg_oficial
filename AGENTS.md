...
Generated at: 2025-11-28T03:20:54.122Z
...
For comprehensive Supabase-specific instructions, see `/rulebook/SUPABASE.md`
...
For comprehensive Notion-specific instructions, see `/rulebook/NOTION.md`
...
For comprehensive Atlassian-specific instructions, see `/rulebook/ATLASSIAN.md`
...
For comprehensive Serena-specific instructions, see `/rulebook/SERENA.md`
...
For comprehensive Figma-specific instructions, see `/rulebook/FIGMA.md`
...
For comprehensive Grafana-specific instructions, see `/rulebook/GRAFANA.md`
